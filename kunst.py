...
def raadiolained(ctx,WIDTH,HEIGHT):
    ...
    for j in range(a):
        ...
        ctx.set_line_width(random.uniform(0.01*x_ja_y_telje_suhe,3*x_ja_y_telje_suhe)) 
        for k in range(b):
            ctx.move_to(algus_x, algus_y) #liigub x,y pidi
...
def ruudustik(ctx,WIDTH,HEIGHT):
    ...
    for j in range(a):
        ...
        line_r, line_g, line_b = line_color[0]/255.0, line_color[1]/255.0, line_color[2]/255.0
        ctx.set_source_rgba(line_r, line_g, line_b, random.uniform(0.1,0.5))
        ctx.set_line_width(random.uniform(0.01*x_ja_y_telje_suhe,1*x_ja_y_telje_suhe))
        ctx.stroke()#kannab kanvasele
...
def paljujoonivasemal(ctx,WIDTH,HEIGHT):
    ...
    for i in range(a):
        ...
        ctx.set_line_width(2*x_ja_y_telje_suhe)#joone laius
        ctx.stroke()#kannab kanvasele
...
def hexagonid_värvilised(ctx,WIDTH,HEIGHT):
    ...
    for i in range(a):
        ...
        HEX_W, HEX_H = (suvaarv*x_ja_y_telje_suhe, suvaarv*x_ja_y_telje_suhe) #hexagoni suurus
...
def jooned_nurgast(ctx,WIDTH,HEIGHT):
    ...
    for i in range(200):
        ...
        line_r, line_g, line_b = line_color[0]/255.0, line_color[1]/255.0, line_color[2]/255.0
        ctx.set_source_rgb(line_r, line_g, line_b)
        ctx.set_line_width(4*x_ja_y_telje_suhe)
...
def susser(ctx,WIDTH,HEIGHT):
    ...
    for i in range(random.randint(5,int(50* x_telje_suhe/y_telje_suhe))):
        ...
        ctx.set_source_rgb(1, 1, 1)#joone värv
        ctx.set_line_width(random.uniform(0,4*x_ja_y_telje_suhe)) #joone laius
        ctx.move_to(x, y)
...
def sussernurgast(ctx,WIDTH,HEIGHT):
    ...
    for i in range(random.randint(int(5* x_telje_suhe/y_telje_suhe),int(30* x_telje_suhe/y_telje_suhe))):
        ...
        x6, y6 = random.randint(0,int(6000* x_telje_suhe)), random.randint(0,int(3000* y_telje_suhe))
        ctx.set_source_rgb(1, 1, 1) #joone värv
        ctx.set_line_width(random.uniform(0,5*x_ja_y_telje_suhe))#joone laius
...
def magnetlained1(ctx,WIDTH,HEIGHT):
    ...
    for i in range(random.randint(int(36* x_telje_suhe/y_telje_suhe),int(500* x_telje_suhe/y_telje_suhe))):
        ...
        ctx.set_source_rgb(1, 1, 1)
        ctx.set_line_width(random.uniform(0,3*x_ja_y_telje_suhe))
        ctx.save()
...
def magnetlained2(ctx,WIDTH,HEIGHT):
    ...
    for i in range(random.randint(int(50* x_telje_suhe/y_telje_suhe),int(500* x_telje_suhe/y_telje_suhe))):
        ...
        ctx.set_line_width(random.uniform(0,3*x_ja_y_telje_suhe)) #joone laius
...
def kiired1(ctx,WIDTH,HEIGHT):
    ...
    x_ja_y_telje_suhe = (x_telje_suhe+y_telje_suhe)/2      
    ctx.translate(WIDTH/2, HEIGHT/2)#konstantse kaugsele viib punktid
    for i in range(random.randint(int(36* x_ja_y_telje_suhe),int(50000* x_ja_y_telje_suhe))):
        line_color = random.choice(list_of_colors)#värvi määramine
        line_r, line_g, line_b = line_color[0]/255.0, line_color[1]/255.0, line_color[2]/255.0
        ...
        ctx.arc(i*x_ja_y_telje_suhe, i*x_ja_y_telje_suhe, 120*x_ja_y_telje_suhe, 0, 2*math.pi)  #kaare koordinaadid(x,y koordinaat, raaidus, nurk 1 ja nurk 2)
        ctx.fill()
        ctx.restore()#taastab punkti
        ctx.stroke()#kannab kanvasele
...
def kiired2(ctx,WIDTH,HEIGHT):
    ...
    x_ja_y_telje_suhe = (x_telje_suhe+y_telje_suhe)/2      
    ctx.translate(WIDTH/2, HEIGHT/2)#konstantse kaugsele viib punktid
    for i in range(random.randint(int(36* x_ja_y_telje_suhe),int(10000* x_ja_y_telje_suhe))):
        ...
        ctx.rotate(i*math.pi/36)# rotatsiooni määr
        ctx.scale(0.3, 1)#skaleerimine
        ctx.arc(i*x_ja_y_telje_suhe, i*x_ja_y_telje_suhe, a*x_ja_y_telje_suhe, 0, 2*math.pi) #kaare koordinaadid(x,y koordinaat, raaidus, nurk 1 ja nurk 2)
        ctx.fill()
        ctx.restore()#taastab punkti
        ctx.stroke()#kannab kanvasele
...
def kiired3(ctx,WIDTH,HEIGHT):
    ...
    ctx.translate(WIDTH/2, HEIGHT/2)#konstantse kaugsele viib punktid
    for i in range(random.randint(int(36* x_ja_y_telje_suhe),int(10000* x_ja_y_telje_suhe))):
        a,d = random.randint(0,int(130* x_ja_y_telje_suhe)),random.randint(1,int(30* x_ja_y_telje_suhe))
        ...
        ctx.arc(i*x_ja_y_telje_suhe, i*x_ja_y_telje_suhe, a*x_ja_y_telje_suhe, a*x_ja_y_telje_suhe, 2*math.pi) #kaare koordinaadid(x,y koordinaat, raaidus, nurk 1 ja nurk 2)
        ctx.fill()
        ctx.restore()#taastab punkti
        ctx.stroke()#kannab kanvasele
...
def kiired5(ctx,WIDTH,HEIGHT):
    ...
    x_ja_y_telje_suhe = (x_telje_suhe+y_telje_suhe)/2      
    ctx.translate(WIDTH/2, HEIGHT/2)#konstantse kaugsele viib punktid
    u,i= random.randint(1,int(100* x_ja_y_telje_suhe)),random.randint(0,int(2000* x_ja_y_telje_suhe))
    for i in range(random.randint(int(36* x_ja_y_telje_suhe),int(10000* x_ja_y_telje_suhe))):
        a,d = random.randint(0,int(130* x_ja_y_telje_suhe)),random.randint(1,int(30* x_ja_y_telje_suhe))
        line_color = random.choice(list_of_colors)
        line_r, line_g, line_b = line_color[0]/255.0, line_color[1]/255.0, line_color[2]/255.0
        ...
        ctx.rotate(i*math.pi/36)# rotatsiooni määr
        ctx.scale(0.3, d)#skaleerimine
        ctx.arc(i*x_ja_y_telje_suhe, i*x_ja_y_telje_suhe, a*x_ja_y_telje_suhe, a*x_ja_y_telje_suhe, u*math.pi) #kaare koordinaadid(x,y koordinaat, raaidus, nurk 1 ja nurk 2)
        ctx.fill()
        ctx.restore()
        ctx.stroke()#kannab kanvasele
...
def kiired6(ctx,WIDTH,HEIGHT):
    ...
    for i in range(random.randint(int(36* x_ja_y_telje_suhe),int(10000* x_ja_y_telje_suhe))):
        ...
        algus_y = random.randint(int(-2000* y_telje_suhe), int(10000* y_telje_suhe))
        ctx.move_to(algus_x, algus_y)
        x = random.randint(0,int(1000* x_ja_y_telje_suhe))
        line_color = random.choice(list_of_colors)#värvi määramine
        line_r, line_g, line_b = line_color[0]/255.0, line_color[1]/255.0, line_color[2]/255.0
        ...
        ctx.rotate(i*math.pi/36)# rotatsiooni määr
        ctx.scale(0.3, 1)#skaleerimine
        ctx.arc(x*x_ja_y_telje_suhe, x*x_ja_y_telje_suhe, 120*x_ja_y_telje_suhe, 0, 2*math.pi) #kaare koordinaadid(x,y koordinaat, raaidus, nurk 1 ja nurk 2)
        ctx.restore()#taastab punkti
        ctx.stroke()#kannab kanvasele